	...
	<fieldset>
    	<legend>新增菜單</legend>
            ...
            <div class=st1>
                ...
                <input type="hidden" id="companyId" name="companyId" size="20" value="${param.companyId}">
                <input type="text" id="menu_name" name="menu_name" size="20" placeholder="請輸入菜色名稱">
            ...
            <div class=st1>
                <label for="price">價格:</label>
                    <input type="text" id="price" name="price" size="20" placeholder="ex:100">
            ...
            <div class="st1">
             ...
             <div class=st1>
                ...
                <textarea id="remark" name="remark" rows="5" cols="40" placeholder="菜色說明..."></textarea>
